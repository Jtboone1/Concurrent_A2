...
public class Elevator extends Thread {
    ...
    public void pickup_new_rider(int pickup_floor)
    {
        ...
        this.wait(5 * Math.abs(this.current_floor - pickup_floor));
        ...
        this.current_floor = pickup_floor;
        ElevatorSimulator.print_info("Elevator " + this.elevator_number + " found rider on floor " + this.destination_floors.get(0) + " from floor " + this.current_floor + " and will now move to that floor!");

        // Once rider is on elevator (Indicated by destination_floor not being empty), start moving!
        if (this.current_floor < rider.destination_floor)
        {
        ...
        while (ElevatorSimulator.SimulationClock.getTick() < ElevatorSimulator.simulationTime)
        {
            ...
            if (this.state == "Stationary Waiting For Requests")
            {
                try 
                {
                    ...
                    ElevatorSimulator.print_info("Elevator " + this.elevator_number + " on floor " + this.current_floor + " is trying to request a rider");
                    find_rider.acquire();
            ...
            else if (this.state == "Intermediate Floor Check")
            {
                ...
                try
                {
                    ...
                    while (!RiderManager.floor_requests.get(current_floor).isEmpty())
                    {
                        ...
                        {
                            ElevatorSimulator.print_info("Elevator " + this.elevator_number + " is turning someone away on floor + " + this.current_floor);
                            RiderManager.floor_requests.get(current_floor).remove(0);
            ...
            else if (this.state == "Unloading At Destination")
            {
                ...
                {
                    ElevatorSimulator.print_info("Elevator " + this.elevator_number + " has stopped moving on floor " + this.current_floor + " and has no requests");
